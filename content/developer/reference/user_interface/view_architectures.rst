...
.. attribute:: name
   ...
   The name of the :ref:`model <reference/orm/model>` field to filter on.
...
.. attribute:: filter_domain
   ...
   The domain to use as the field's search domain, as a Python expression that to a :ref:`domain
...
.. attribute:: field
   ...
   The name of the :ref:`model <reference/orm/model>` field on which the progress bar's sub-groups
   are based.
...
.. attribute:: sum_field
   ...
   The name of the :ref:`model <reference/orm/model>` field to use in a sum displayed next to the
   progress bar. If not set, the total number of records is displayed instead.
